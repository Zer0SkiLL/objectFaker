<template>
    <div class="container m-6">
        ...
        <div class="section has-text-centered">
            ...
            <div
                class="users is-flex is-justify-content-center is-flex-wrap-wrap"
            >
            ...
            <div class="section buttons is-centered">
                <a :href="`/api/fake-users?take=${take}`" class="button is-link"
                    >Nuxt3 Server API Endpoint</a
                >
                <a :href="`/fake-users?take=${take}`" class="button is-warning"
